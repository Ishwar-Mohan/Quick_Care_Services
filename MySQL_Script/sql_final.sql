...
CREATE TABLE `quickcare`.`patient_details` (
  ...
  INDEX `caretaker_id_idx` (`caretaker_id` ASC) ,
  CONSTRAINT `cust_id`
    FOREIGN KEY (`cust_id`)
...
CREATE TABLE `quickcare`.`feedback` (
  ...
  INDEX `patient_fkid_idx` (`patient_id` ASC) ,
  INDEX `caretaker_fkid_idx` (`caretaker_id` ASC) ,
...
CREATE TABLE `quickcare`.`booking_details` (
  ...
  INDEX `cust_bd_id_idx` (`cust_id` ASC) ,
  INDEX `caretaker_bd_id_idx` (`caretaker_id` ASC) ,
  INDEX `patient_bd_id_idx` (`patient_id` ASC) ,
...
CREATE TABLE `quickcare`.`payment` (
  ...
  INDEX `caretaker_p_id_idx` (`caretaker_id` ASC ),
  INDEX `patient_p_id_idx` (`patient_id` ASC) ,
